#!/usr/bin/env bash
NAME="aclImdbSimpleAnalysis_nounlab_mixed"
OUT="temp/$NAME"
...
--multi_gpu --input ${OUT}/data --output_path ${OUT}/model --exp_name "aclImdb_nounlab_mixed" \
--use_pretrained_embeddings --nepoch_no_imprv 20 --timedistributed --d_hidden 512 \
--nepochs 50 --optim adam --beta1 0.0 --beta2 0.98 \
--wbatchsize 3000 --lambda_at 1.0 --lambda_vat 1.0 --lambda_entropy 1.0