...
def work(id, queue):
    ...
    while True:
        ...
        arg_string = \
        'env CUDA_VISIBLE_DEVICES={} PYTHONIOENCODING=utf-8 python main.py --corpus rcv1 --model LSTMEncoder '\
        '--debug --save_data demo_fastText '\
        '--multi_gpu --input temp/rcv1_pretrained/data --output_path temp/rcv1_pretrained/model '\
        '--exp_name rcv1_clf_mixed_{} '\
