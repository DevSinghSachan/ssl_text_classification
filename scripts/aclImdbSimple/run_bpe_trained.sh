...
NAME="aclImdbSimple_bpe"
OUT="temp/$NAME"

mkdir -p $OUT/data

# Preprocess
python preprocess.py --corpus aclImdbSimple_bpe --output ${OUT}/data
...
# Train the model
PYTHONIOENCODING=utf-8 python main.py --corpus aclImdbSimple_bpe --model LSTMEncoder --debug \
--multi_gpu --input ${OUT}/data --output_path ${OUT}/model --model_file "bpe_pretrained_training.pt" \
